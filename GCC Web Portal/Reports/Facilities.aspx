<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="Facilities.aspx.cs" Inherits="GCC_Web_Portal.Facilities" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentHeader" runat="server">
    <h1>Facilities Dashboard: <%= PropertyTools.GetCasinoName( (int)PropertyShortCode ) %></h1>
    <ol class="breadcrumb">
        <li><a href="/">Home</a></li>
        ...
        <div class="col-xs-12 col-md-4">
            <div class="box box-info">
                ...
                <div class="box-body border-radius-none">
                    <div>
                        <canvas id="chart-FacilitiesScore" class="chart" height="230" style="height:230px"></canvas>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-8">
            <div class="box box-warning">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Casino Facilities</h3>
                </div>
                <div class="box-body border-radius-none">
                    <table class="table table-bordered table-striped" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                <th>Ambiance, mood, atmosphere of the environment</th>
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Ambience", "_T2B" ) %></td>
                                <td><div id="Ambience" class="mini-chart"></div></td>
                            </tr>
                            <tr>
                                <th>Cleanliness of general areas</th>
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Cleanliness", "_T2B" ) %></td>
                                <td><div id="Cleanliness" class="mini-chart"></div></td>
                            </tr>
                            <tr>
                                <th>Clear signage</th>
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Signage", "_T2B" ) %></td>
                                <td><div id="Signage" class="mini-chart"></div></td>
                            </tr>
                            <tr>
                                <th>Washroom cleanliness</th>
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Washroom", "_T2B" ) %></td>
                                <td><div id="Washroom" class="mini-chart"></div></td>
                            </tr>
                            <tr>
                                <th>Adequate  lighting - it is bright enough</th>
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Lighting", "_T2B" ) %></td>
                                <td><div id="Lighting" class="mini-chart"></div></td>
                            </tr>
                            <tr>
                                <th>Safe environment</th>
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Safe", "_T2B" ) %></td>
                                <td><div id="Safe" class="mini-chart"></div></td>
                            </tr>
                            <tr>
                                <th>Parking availability</th>
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Parking", "_T2B" ) %></td>
                                <td><div id="Parking" class="mini-chart"></div></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterScripts" runat="server">
    ...
    <script>
        ...
        $.jqplot('Ambience', <%= GetJSData( propOverall, "Ambience" ) %>, opts);
        $.jqplot('Cleanliness', <%= GetJSData( propOverall, "Cleanliness" ) %>, opts);
        $.jqplot('Signage', <%= GetJSData( propOverall, "Signage" ) %>, opts);
        $.jqplot('Washroom', <%= GetJSData( propOverall, "Washroom" ) %>, opts);
        $.jqplot('Lighting', <%= GetJSData( propOverall, "Lighting" ) %>, opts);
        $.jqplot('Safe', <%= GetJSData( propOverall, "Safe" ) %>, opts);
        $.jqplot('Parking', <%= GetJSData( propOverall, "Parking" ) %>, opts);
