<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="Lounge.aspx.cs" Inherits="GCC_Web_Portal.Lounge" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentHeader" runat="server">
    <h1>Lounge Dashboard: <%= PropertyTools.GetCasinoName( (int)PropertyShortCode ) %></h1>
    <ol class="breadcrumb">
        <li><a href="/">Home</a></li>
        <li><a href="/PropertyDashboard/<%= PropertyShortCode.ToString() %>">Property Dashboard</a></li>
        <li class="active">Lounge Dashboard</li>
    </ol>
</asp:Content>
    ...
    <div class="row">
        <div class="col-xs-12 col-md-4">
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Lounge Score</h3>
                </div>
                <div class="box-body border-radius-none">
                    <div>
                        <canvas id="chart-LoungeScore" class="chart" height="230" style="height:230px"></canvas>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-md-4">
            <div class="box box-info">
                <div class="box-header with-border">
                    <i class="fa fa-line-chart"></i>
                    <h3 class="box-title">Lounge Attendance</h3>
                </div>
                <div class="box-body border-radius-none">
                    <div>
                        <canvas id="chart-VisitedLoungeScore" class="chart" height="230" style="height:230px"></canvas>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-8">
            <div class="box box-warning">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Casino Lounge</h3>
                </div>
                <div class="box-body border-radius-none">
                    <table class="table table-bordered table-striped" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Entertainment", "_T2B" ) %></td>
                                <td><div id="Entertainment" class="mini-chart"></div></td>
                            </tr>
                            <tr>
                                <th>Sound / quality</th>
                            ...
                            <tr>
                                <th>Dance floor</th>
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Dance", "_T2B" ) %></td>
                                <td><div id="Dance" class="mini-chart"></div></td>
                            </tr>
                            <tr>
                                <th>Fun and enjoyable atmosphere</th>
                                <td><%= ReportingTools.CalculatePercent( propOverall, "Fun", "_T2B" ) %></td>
                                <td><div id="Fun" class="mini-chart"></div></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterScripts" runat="server">
    ...
    <script>
        ...
        $.jqplot('Entertainment', <%= GetJSData( propOverall, "Entertainment" ) %>, opts);
        $.jqplot('Sound', <%= GetJSData( propOverall, "Sound" ) %>, opts);
        $.jqplot('Seating', <%= GetJSData( propOverall, "Seating" ) %>, opts);
        $.jqplot('Dance', <%= GetJSData( propOverall, "Dance" ) %>, opts);
        $.jqplot('Fun', <%= GetJSData( propOverall, "Fun" ) %>, opts);
