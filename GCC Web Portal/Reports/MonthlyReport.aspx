<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="MonthlyReport.aspx.cs" Inherits="GCC_Web_Portal.MonthlyReport"
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentHeader" runat="server">
    <h1><i class="fa fa-calendar"></i> Monthly Report</h1>
    <ol class="breadcrumb">
        <li><a href="/">Home</a></li>
