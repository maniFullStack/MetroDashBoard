                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group date-range-filter">
                            ...
                            <uc1:DateRangeFilterControl runat="server" ID="drDateRangeFirst" SessionKey="fltDateRange" Label="Choose..." />
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group date-range-filter">
                            <label>Second Date Range</label><br />
                            <uc1:DateRangeFilterControl runat="server" ID="drDateRangeSecond" SessionKey="fltDateRange2" Label="Choose..." />
                        </div>
                    </div>
                </div>
                <div class="row">
