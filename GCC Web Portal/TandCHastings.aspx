<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TandCHastings.aspx.cs" Inherits="GCC_Web_Portal.TandCHastings" %>
...
<body>
    ...
    <div class="container">
        <div class="col-xs-12" id="main-content">
            <h1>Hastings Racecourse Customer Survey</h1>
            <h3>Terms of Use</h3>
            <ul>
                <li>To enter and be eligible to win, the entrant must answer all mandatory questions on the Hastings Racecourse Customer Survey.</li>
            ...
            <h3>Hastings Racecourse Customer Survey Contest Conditions</h3>
            <p>For the 2017 live horse racing season.</p>
            <h4>Qualified Entry and Entrant</h4>
            <ul>
                <li>A qualified entrant (Entrant) is someone who is 19 years of age or older and a Canadian resident. Employees of Great Canadian Gaming Corporation, its subsidiaries and affiliates, collectively referred to as "GCGC" the British Columbia Lottery Corporation (BCLC) and Nova Scotia Provincial Lotteries and Casino Corporation (NSPLCC), as well as family and household members of same who reside at the same address are not eligible.</li>
            ...
            <p>The Contest Period runs from when the Hastings Racecourse Customer Survey's link is released to the public until the end of the 2017 horse racing season at Hastings Racecourse, or on such other date and time as posted by GCGC.</p>
            <h4>Prize Draw</h4>
            <ul>
                <li>To enter and be eligible to win, the entrant must answer all mandatory questions on the Hastings Racecourse Customer Survey.</li>
                <li>Entries must be made directly on the Survey site provided via a link in an email sent from GCGC, or via tablet at Hastings Racecourse. Photocopies, faxes, emails or phone calls are not considered eligible entries.</li>
                ...
                <li>One (1) grand prize winner will be selected randomly from the pool of entrants on the 1st day of the month after the close of the 2017 racing season. The draw process is as follows:</li>
                <li>All entries will be collected during the Contest Period.</li>
                <li>At the end of the contest period, all eligible entries will be gathered and duplicates removed based on email address.</li>
                <li>All entries will then be assigned a number based on when the entry was received, starting at 1.</li>
                <li>Once the total number of entries has been determined, a random number generator will be used to pick a winning entry from the list.</li>
                <li>Random number generation is in no way influenced by any employee of GCGC.</li>
                <li>One (1) weekly prize winner will be selected from the pool of survey respondents received up to the date of the weekly draw, from the date the survey is released to the public and continuing each week up to the close of the 2017 racing season.  The draw process is as follows:</li>
                <li>At the end of each race week, all eligible entries received to date will be gathered and duplicates removed based on email address.</li>
                <li>All entries will then be assigned a number based on when the entry was received, starting at 1.</li>
                <li>Once the total number of entries has been determined, a random number generator will be used to pick a winning entry from the list.</li>
                <li>Random number generation is in no way influenced by any employee of GCGC.</li>
                <li>Guests will have multiple chances to win the daily prize based on how many weeks  remain in the season.</li>
                ...
                <li>Odds of winning will depend on the number of eligible entries received before the end of each race day, or by the contest deadline.</li>
                <li>Winning Entrants will be contacted as soon as possible after the draw by GCGC through email.</li>
                <li>Winning Entrants will have ten (10) days to claim their prize, after which prize is forfeited and becomes the property of GCGC.</li>
                <li>The grand prize winning Entrant will receive one (1) Reserved Box for 6 people, $100 in Food & Beverage credits and an opportunity to present a race</li>
                <li>The weekly prize winning Entrants will receive one (1) Reserved Box for 6 people.</li>
