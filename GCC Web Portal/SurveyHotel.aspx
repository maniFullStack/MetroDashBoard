...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <p>By clicking "Done" below, you acknowledge that you are aware that your personal information (contact information and feedback) is being collected and used by Great Canadian Casino Corporation (GCGC) on behalf of BCLC in accordance with British Columbia's Freedom of Information and Protection of Privacy Act. It will only be used for GCGC's reporting & research purposes and to administer the guest feedback process.</p>
