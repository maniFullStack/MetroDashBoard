...
{
    public partial class SurveySnapshot2015 : BasePage
    {
        ...
        protected bool SaveData()
        {
            ...
            int rowID = sql.QueryAndReturnIdentity(String.Format("INSERT INTO [tblSurveySnapshot2016] ({0}) VALUES ({1});", columnList, columnList.ToString().Replace("[", "@").Replace("]", String.Empty)), sqlParams);
