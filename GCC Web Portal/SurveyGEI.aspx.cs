...
namespace GCC_Web_Portal
{
    public partial class SurveyGEI : BasePage
    {
        ...
        protected void Page_PreInit( object sender, EventArgs e ) {
            ...
            else if(PropertyShortCode == GCCPropertyShortCode.CNB || PropertyShortCode == GCCPropertyShortCode.SCTI)
            {
                ...
                case 20: //Q36-40
                    ...
                    if(strSurveyLang != "French")
                    {
                        ...
                        if (!saveOnly)
                        {
                            ...
                            if (!CheckForAnswer(OLGYesNo) && (PropertyShortCode == GCCPropertyShortCode.SCTI || PropertyShortCode == GCCPropertyShortCode.SSKD))
                            {
                                retVal = false;
                            }
                            else
                    ...
                    else if(strSurveyLang == "French")
                    {
                        ...
                        if (!saveOnly)
                        {
                            ...
                            if (!CheckForAnswer(OLGYesNo_F) && (PropertyShortCode == GCCPropertyShortCode.SCTI || PropertyShortCode == GCCPropertyShortCode.SSKD))
                            {
                                retVal = false;
                            }
                            else
