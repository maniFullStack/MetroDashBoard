<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SixQuestionRowControl.ascx.cs" Inherits="GCC_Web_Portal.Controls.SixQuestionRowControl" %>
<div class="question-row">
    ...
    <div class="row grid-row">
        ...
        <% } %>
        <div class="col-md-<%= colSpan %> col-xs-2 option"><asp:RadioButton ID="radAnswer6" runat="server" GroupName="QRC" Text="" /></div>
