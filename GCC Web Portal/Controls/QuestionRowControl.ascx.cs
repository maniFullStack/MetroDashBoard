...
{
    public partial class QuestionRowControl : System.Web.UI.UserControl, ISurveyControl<int>
    {
        /// <summary>
        ...
        public void SetAnswerLabels(string[] labels)
        {
            ...
            radAnswer4.Text = labels[4];
            radAnswer5.Text = labels[5];
        }

        public QuestionRowControl()
        {
            ShowNAColumn = false;
        }
        ...
        {
            base.OnInit(e);
            SetAnswerLabels(new string[] { "Don't Know / N/A", "Poor", "Fair", "Good", "Very Good", "Excellent" });
        }
