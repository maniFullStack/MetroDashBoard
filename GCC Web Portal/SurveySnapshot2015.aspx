<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveySnapshot2015.aspx.cs" Inherits="GCC_Web_Portal.SurveySnapshot2015" MasterPageFile="~/Survey.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="mainContent">
    ...
    <% if ( DateTime.Now < ReportingTools.AdjustDateTime( new DateTime( 2016, 8, 5, 0, 0, 1 ), true, "Pacific Standard Time" ) ) { %>
    <p>Thank you for visiting. The Great Canadian Snapshot 2017 survey is not yet open.</p>
    <p>It will be available from <strong>1AM PDT on August 5, 2017 to 11:59PM PDT on August 25, 2017.</strong></p>
    <p>Please try back between those times.</p>
    <% } else if ( DateTime.Now >= ReportingTools.AdjustDateTime( new DateTime( 2018, 8, 25, 23, 59, 59 ), true, "Pacific Standard Time" ) ) { %>
