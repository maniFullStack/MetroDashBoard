<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TandSCTI_French.aspx.cs" Inherits="GCC_Web_Portal.TandSCTI_French" %>
    ...
    <form runat="server">
        <div class="container">
            <div class="col-xs-12" id="main-content">
                <h1>Programme de rétroaction des clients du Casino Shorelines à Thousand Islands  </h1>
...
<li> La GCGC a le droit de publier le nom et l'emplacement du gagnant sans rémunération.</li>
                ...
                <h3>Conditions du concours du sondage sur l’expérience des clients du Casino Shorelines à Thousand Islands  </h3>
