    ...
    public partial class SurveyFeedback : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                fbkProperty.Items.Insert(17, new ListItem(Lang.Page1_Question2_1, "1")); //No Specific Property
        ...
        protected void Page_LoadComplete(object sender, EventArgs e)
        {
            ...
            //slots
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "HRCV", "HA", "VRL", "NAN", "CCH", "CMR", "CDC", "CNSH", "CNSS", "EC", "SSKD", "SCTI", "CNB" ,"SCBE"}.Contains(AlignedPropertyShortCode.ToString()));
            //Table Games / Poker
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "HRCV", "VRL", "NAN", "GAG", "CNSH", "CNSS", "EC", "SCTI", "CNB","SCBE" }.Contains(AlignedPropertyShortCode.ToString()));
            //Bingo
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "CCH", "CMR", "CDC" }.Contains(AlignedPropertyShortCode.ToString()));
            //Food & Beverage
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "HRCV", "HA", "VRL", "NAN", "CCH", "CMR", "CDC", "GAG", "CNSH", "CNSS", "EC", "SSKD", "SCTI", "CNB","SCBE" }.Contains(AlignedPropertyShortCode.ToString()));
            //Entertainment
            ...
            //Racebook
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "HRCV", "HA", "NAN", "CMR", "CNSS", "EC", "SSKD","SCBE" }.Contains(AlignedPropertyShortCode.ToString()));
            //Horse Racing
            ...
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "HRCV", "HA", "VRL", "NAN", "CCH", "CMR", "CDC", "GAG", "CNSH", "CNSS", "EC", "SSKD", "SCTI", "CNB", "SCBE" }.Contains(AlignedPropertyShortCode.ToString()));
            //Parking
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "SSKD", "SCTI","CNB", "SCBE" }.Contains(AlignedPropertyShortCode.ToString()));
            //Marketing & Promotions
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "HRCV", "HA", "VRL", "NAN", "CCH", "CMR", "CDC", "GAG", "CNSH", "CNSS", "EC", "SSKD", "SCTI", "CNB", "SCBE" }.Contains(AlignedPropertyShortCode.ToString()));
            //Group Sales / Catering / Events
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "CNSH", "SSKD", "SCTI", "SCBE","CNB" }.Contains(AlignedPropertyShortCode.ToString()));
            //Sponsorship Request
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "HRCV", "HA", "VRL", "NAN", "CCH", "CMR", "CDC", "GAG", "CNSH", "CNSS", "EC", "SSKD", "SCTI", "CNB" }.Contains(AlignedPropertyShortCode.ToString()));
            //Responsible Gaming
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "HRCV", "HA", "VRL", "NAN", "CCH", "CMR", "CDC", "GAG", "CNSH", "CNSS", "EC", "SSKD", "SCTI", "CNB", "SCBE" }.Contains(AlignedPropertyShortCode.ToString()));
            //Investor Relations
            fbkQ2.Items[j++].Enabled = (new[] { "GCC", "RR", "HRCV", "HA", "VRL", "NAN", "CCH", "CMR", "CDC", "GAG", "CNSH", "CNSS", "EC", "SSKD", "SCTI", "CNB", "SCBE" }.Contains(AlignedPropertyShortCode.ToString()));
            ...
            if (AlignedPropertyShortCode.ToString() == "CNB" || AlignedPropertyShortCode.ToString() == "SCTI")
            {
