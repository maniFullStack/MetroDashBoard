...
<asp:Content runat="server" ContentPlaceHolderID="mainContent">
    ...
    <p>No purchase necessary. An Entrant may only enter the contest once during the promotional period. Duplicate entries will be deleted. Your personal information is collected and used by Great Canadian Gaming Corporation (GCGC) in accordance with British Columbia's Freedom of Information and Protection of Privacy Act.  Your information will not be sold, shared with third parties, or used for soliciting purposes. If you have any questions about this, please write to GCGC's Privacy Officer at 95 Schooner Street, Coquitlam, BC V3K 7A8.</p>
    <% } else { %>
