			...
			<div class="cover-container">
				<form id="form" runat="server" class="inner cover form-horizontal" role="form" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="password" class="form-control" id="txtNewPass1" name="newpwd1" maxlength="20" minlength ="6" value="" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-offset-1 col-sm-4 control-label" for="txtNewPass2">Confirm Password</label>
						<div class="col-sm-4">
							<input type="password" class="form-control" id="txtNewPass2" name="newpwd2" maxlength="20" minlength="6" value="" />
						</div>
					</div>
