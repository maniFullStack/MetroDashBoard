<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TandCCNB.aspx.cs" Inherits="GCC_Web_Portal.TandCCNB" %>
    ...
    <form runat="server">
        <div class="container">
            <div class="col-xs-12" id="main-content">
                <h1>Casino New Brunswick Guest Feedback Program</h1>
                <h3>Terms of Use</h3>
                <ul>
                ...
                <h3>Casino New Brunswick Guest Experience Survey Contest Conditions</h3>
                ...
                <h4>Prize Draw</h4>
                <ul>
                    <li>To enter and be eligible to win, the entrant must answer all mandatory questions on the Casino New Brunswick Guest Experience Survey. </li>
                    ...
                    <li>The winning Entrant will receive four (4) dinner buffets valid for redemption at Casino New Brunswick.</li>
