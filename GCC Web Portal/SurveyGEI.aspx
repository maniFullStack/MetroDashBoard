...
<br />
 Veuillez choisir toutes les réponses qui s'appliquent.
				...
				<p>
					...
					<% } %>
					<% if (PropertyShortCode == GCCPropertyShortCode.SSKD || PropertyShortCode == GCCPropertyShortCode.AJA)
					   { %>
					<sc:SurveyCheckBox ID="Q18_47" runat="server" SessionKey="Q18_47" DBColumn="Q18_47" DBValue="1" Text="&nbsp;Player's Lounge and Café" /><br />
					<% } %>
					<% if (PropertyShortCode == GCCPropertyShortCode.SCTI || PropertyShortCode == GCCPropertyShortCode.WDB || PropertyShortCode == GCCPropertyShortCode.GBH)
					   { %>
