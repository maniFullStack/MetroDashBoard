        ...
        <div class="container">
            <div class="col-xs-12" id="main-content">
               ...
               <%-- <% if(strSurveyLang != "French") { %>
                ...
                <%if (PropertyShortCode == GCCPropertyShortCode.CNB || PropertyShortCode == GCCPropertyShortCode.SCTI)
                      { %>
                ...
                <div runat="server" id="English">
                    ...
                    <% if ( PropertyShortCode == GCCPropertyShortCode.GAG || PropertyShortCode == GCCPropertyShortCode.SSKD || PropertyShortCode == GCCPropertyShortCode.SCTI ||PropertyShortCode== GCCPropertyShortCode.SCBE ) { %>
                    ...
                    <p>Your enjoyment is important to us, and we would be delighted if you would share your thoughts and experiences with us by completing this survey. <br /> To show our appreciation for your time, you will be entered into a draw to win <b><%= PropertyTools.GetSurveyPrize( PropertyShortCode ) %></b>!</p>
                ...
                <div runat="server" id="French">
                    ...
                    <% if ( PropertyShortCode == GCCPropertyShortCode.GAG || PropertyShortCode == GCCPropertyShortCode.SSKD || PropertyShortCode == GCCPropertyShortCode.SCTI ) { %>
                    ...
                    <p>La qualité de votre expérience nous tient à cœur et nous serions très reconnaissants si vous partagiez vos impressions et votre expérience avec nous en répondant à ce sondage.<br /> Pour vous remercier de votre temps, vous serez admissible au tirage pour gagner <b><%= PropertyTools.GetSurveyPrize_French( PropertyShortCode ) %></b>!</p>
                ...
                <p>
                    <asp:Panel runat="server">
                        <% if (new[] { "RR", "HRCV", "HA", "VRL", "NAN", "CCH", "CMR", "CDC", "CNSH", "CNSS", "EC", "SSKD", "SCTI", "CNB","SCBE" }.Contains(PropertyShortCode.ToString()))
                           { %>
                        ...
                        <% } %>
                        <% if (new[] { "RR", "HRCV", "VRL", "NAN", "CNSH", "CNSS", "GAG", "EC", "SCTI", "CNB","SCBE" }.Contains(PropertyShortCode.ToString()))
                           { %>
                        ...
                        <% } %>
                        <% if (new[] { "RR", "HRCV", "HA", "NAN", "CMR", "EC", "SSKD","SCBE" }.Contains(PropertyShortCode.ToString()))
                           { %>
                ...
                <p>
                    <% if (new[] { "RR", "HRCV", "HA", "VRL", "NAN", "CCH", "CMR", "CDC", "CNSH", "CNSS", "EC", "SSKD", "SCTI", "CNB","SCBE" }.Contains(PropertyShortCode.ToString()) && !radQ1_Slots.Checked)
                       { %>
                    <sc:SurveyCheckBox ID="chkQ2_Slots" runat="server" SessionKey="Q2Slots" DBColumn="Q2_Slots" DBValue="1" Text="&nbsp;Playing Slots" /><br />
                    <% } %>
                    <% if (new[] { "RR", "HRCV", "VRL", "NAN", "CNSH", "CNSS", "GAG", "EC", "SCTI", "CNB","SCBE" }.Contains(PropertyShortCode.ToString()) && !radQ1_Tables.Checked)
                       { %>
                    ...
                    <% } %>
                    <% if (new[] { "RR", "HRCV", "VRL", "CCH", "CMR", "CDC", "CNSH", "EC", "SCTI", "CNB" }.Contains(PropertyShortCode.ToString()) && !radQ1_Entertainment.Checked)
                       { %>
                    ...
                    <% } %>
                    <% if (new[] { "RR", "HRCV", "HA", "NAN", "CMR", "EC", "SSKD","SCBE" }.Contains(PropertyShortCode.ToString()) && !radQ1_Racebook.Checked)
                       { %>
...
<br />
 Veuillez choisir toutes les réponses qui s'appliquent.
                ...
                <% } %>
                <% } %>
                <% if (Q18_2.Checked || Q18_14.Checked || Q18_21.Checked || Q18_26.Checked || Q18_32.Checked || Q18_34.Checked || Q18_35.Checked || Q18_36.Checked || Q18_37.Checked || Q18_41.Checked || Q18_47.Checked || Q18_48.Checked || Q18_49.Checked || Q18_53.Checked)
                   { %>
                ...
                <% if (Q18_3.Checked || Q18_15.Checked || (Q18_25.Checked && PropertyShortCode == GCCPropertyShortCode.EC) || Q18_27.Checked || Q18_33.Checked || Q18_38.Checked || Q18_50.Checked || Q18_54.Checked)
                   { %>
                ...
                <% if (Q18_5.Checked || Q18_17.Checked || Q18_29.Checked || Q18_40.Checked || Q18_44.Checked || Q18_52.Checked )
                   { %>
                ...
                <% } %>
                <% } %>
                <% if (Q18_2_F.Checked || Q18_14_F.Checked || Q18_21_F.Checked || Q18_26_F.Checked || Q18_32_F.Checked || Q18_34_F.Checked || Q18_35_F.Checked || Q18_36_F.Checked || Q18_37_F.Checked || Q18_41_F.Checked || Q18_47_F.Checked || Q18_48_F.Checked || Q18_49_F.Checked || Q18_53_F.Checked)
                   { %>
                ...
                <% } %>
                <%--<% if (Q18_3.Checked || Q18_15.Checked || Q18_22.Checked || ( Q18_25.Checked && PropertyShortCode == GCCPropertyShortCode.EC ) || Q18_27.Checked || Q18_33.Checked || Q18_38.Checked) { %>--%>
                <% if (Q18_3_F.Checked || Q18_15_F.Checked || (Q18_25_F.Checked && PropertyShortCode == GCCPropertyShortCode.EC) || Q18_27_F.Checked || Q18_33_F.Checked || Q18_38_F.Checked || Q18_50_F.Checked || Q18_54_F.Checked)
                   { %>
                ...
                <% } %>
                <%--  <% if (Q18_5.Checked || Q18_17.Checked || Q18_24.Checked || Q18_29.Checked || Q18_40.Checked || Q18_44.Checked) { %>--%>
                <% if (Q18_5_F.Checked || Q18_17_F.Checked || Q18_29_F.Checked || Q18_40_F.Checked || Q18_44_F.Checked || Q18_52_F.Checked )
                   { %>
                ...
                <% if (PropertyShortCode == GCCPropertyShortCode.SSKD || PropertyShortCode == GCCPropertyShortCode.SCTI || PropertyShortCode == GCCPropertyShortCode.SCBE)
                   { %>
                <p class="question">
