...
<body class="survey">
	<form runat="server">
		...
		{ %>
				...
				<p>Your personal information is collected and used by <%= CasinoName %> on behalf of Great Canadian Gaming Corporation (GCGC) and Ontario Lottery and Gaming Corporation (OLG) in accordance with the Ontario Lottery and Gaming Corporation Act. It will be used for GCGC's research purposes only. Your information will not be sold, shared with third parties, or used for soliciting purposes. If you have any questions about this, please write to GCGC's Privacy Officer at 95 Schooner Street, Coquitlam, BC V3K 7A8.</p>
				<p>Please click "Next" to continue.</p>
				<% } else { %>
					
					<p>Your personal information is collected and used by Great Canadian Gaming Corporation (GCGC) on behalf of Great Canadian Gaming Corporation (GCGC) and Ontario Lottery and Gaming Corporation (OLG) in accordance with the Ontario Lottery and Gaming Corporation Act. It will be used for GCGC's research purposes only. Your information will not be sold, shared with third parties, or used for soliciting purposes. If you have any questions about this, please write to GCGC's Privacy Officer at 95 Schooner Street, Coquitlam, BC V3K 7A8.</p>
				<p>Please click "Next" to continue.</p>
				...
				<% }
				   ...
				   { %>
				<p>No purchase necessary. An Entrant may only enter the contest once during the promotional period. The contest promotional period will close at the end of the month in which this survey was completed. Duplicate entries will be deleted. Your personal information is collected by Forum Research and used by <%= CasinoName %>  on behalf of Great Canadian Gaming Corporation (GCGC) and Ontario Lottery and Gaming Corporation (OLG) in accordance with the Ontario Lottery and Gaming Corporation Act. Your personal information is used for the purposes of: administering this contest, for customer service research, and for Responsible Gaming research. If you require a response to your feedback, your personal information will be used to contact you and may be shared with OLG. Your information will not be sold, shared with third parties, or used for soliciting purposes. If you have any questions about this, please write to GCGC's Privacy Officer at 95 Schooner Street, Coquitlam, BC V3K 7A8.</p>
				<% }
				...
				<p>No purchase necessary. An Entrant may only enter the contest once during the promotional period. The contest promotional period will close at the end of the month in which this survey was completed. Duplicate entries will be deleted. Your personal information is collected and used by Great Canadian Gaming Corporation (GCGC) for GCGC's research purposes only. Any personal information provided is managed according to the Right to Information and Protection of Privacy Act of New Brunswick (RTIPPA NB) and other applicable legislation. Your information is kept confidential and secure and is not disclosed to anyone outside of the company or other third parties without your consent, unless required by law or regulation. If you have any questions about this, please write to GCGC's Privacy Officer at 95 Schooner Street, Coquitlam, BC V3K 7A8.</p>
					...
					<% } else if (PropertyShortCode == GCCPropertyShortCode.ECB|| PropertyShortCode == GCCPropertyShortCode.ECF|| PropertyShortCode == GCCPropertyShortCode.ECGR|| PropertyShortCode == GCCPropertyShortCode.ECM) { %>
				...
				<% } 
					 ...
					 { %>
				<p>No purchase necessary. An Entrant may only enter the contest once during the promotional period. The contest promotional period will close at the end of the month in which this survey was completed. Duplicate entries will be deleted. Your personal information is collected and used by Great Canadian Gaming Corporation (GCGC) on behalf of the British Columbia Lottery Corporation in accordance with British Columbia's Freedom of Information and Protection of Privacy Act.  Your information will not be sold, shared with third parties, or used for soliciting purposes. If you have any questions about this, please write to GCGC's Privacy Officer at 95 Schooner Street, Coquitlam, BC V3K 7A8.</p>
				<% } %>
	   ...
	   { %>
				...
				<p>
					<asp:Panel runat="server">
						<% if (new[] { "RR", "HRCV", "HA","ECV", "NAN", "CCH", "CMR", "CDC", "CNSH", "CNSS","ECS", "SSKD","AJA", "SCTI", "CNB","SCBE", "WDB", "GBH", "ECB","ECF","ECGR","ECM" }.Contains(PropertyShortCode.ToString()))
						   { %>
						...
						<% } %>
						<% if (new[] { "RR", "HRCV","ECV", "NAN", "CNSH", "CNSS", "GAG","ECS", "SCTI", "CNB","SCBE" ,"WDB","GBH", "ECB","ECF","ECM"}.Contains(PropertyShortCode.ToString()))
						   { %>
						...
						<% } %>
						<% if (new[] { "RR", "HRCV","ECV", "NAN", "CNSH", "CNSS","ECS", "CNB","SCBE" }.Contains(PropertyShortCode.ToString()))
						   { %>
						...
						<% if (new[] { "RR", "HRCV","ECV", "CCH", "CMR", "CDC", "CNSH","ECS", "SCTI", "CNB", "ECF", "ECM" }.Contains(PropertyShortCode.ToString()))
						   { %>
						...
						<% } %>
						<% if (new[] { "FD", "HA","ECS" }.Contains(PropertyShortCode.ToString()))
						   { %>
						...
						<% } %>
						<% if (new[] { "RR", "HRCV", "HA", "NAN", "CMR","ECS", "SSKD", "AJA", "SCBE","ECF","ECGR","ECM" }.Contains(PropertyShortCode.ToString()))
						   { %>
						...
						<% } %>
						<% if (!new[] { "CNSH", "CNSS","ECS","CNB","ECGR", "ECB"}.Contains(PropertyShortCode.ToString()))
						   { %>
				...
				<p>
					<asp:Panel runat="server">
						...
						<% if (new[] { "RR", "HRCV","ECV", "CCH", "CMR", "CDC", "CNSH","ECS", "SCTI", "CNB", "GBH", "ECF", "ECM" }.Contains(PropertyShortCode.ToString()))
						   { %>
						...
						<% } %>
						<% if (!new[] { "CNSH", "CNSS","ECS","CNB"}.Contains(PropertyShortCode.ToString()))
						   { %>
				...
				<p>
					<% if (new[] { "RR", "HRCV", "HA","ECV", "NAN", "CCH", "CMR", "CDC", "CNSH", "CNSS","ECS", "SSKD", "AJA", "SCTI", "CNB", "SCBE", "WDB", "GBH","ECB","ECF","ECGR","ECM" }.Contains(PropertyShortCode.ToString()) && !radQ1_Slots.Checked)
					   { %>
					<sc:SurveyCheckBox ID="chkQ2_Slots" runat="server" SessionKey="Q2Slots" DBColumn="Q2_Slots" DBValue="1" Text="&nbsp;Playing Slots" /><br />
					<% } %>
					<% if (new[] { "RR", "HRCV","ECV", "NAN", "CNSH", "CNSS", "GAG","ECS", "SCTI", "CNB", "SCBE", "WDB", "GBH" ,"ECB","ECF","ECM" }.Contains(PropertyShortCode.ToString()) && !radQ1_Tables.Checked)
					   { %>
					<sc:SurveyCheckBox ID="chkQ2_Tables" runat="server" SessionKey="Q2Tables" DBColumn="Q2_Tables" DBValue="1" Text="&nbsp;Playing Tables" /><br />
					<% } %>
					<% if (new[] { "RR", "HRCV","ECV", "NAN", "CNSH", "CNSS","ECS", "CNB","SCBE" }.Contains(PropertyShortCode.ToString()) && !radQ1_Poker.Checked)
					   { %>
					...
					<% } %>
					<% if (new[] { "RR", "HRCV","ECV", "CCH", "CMR", "CDC", "CNSH","ECS", "SCTI", "CNB", "GBH", "ECF", "ECM" }.Contains(PropertyShortCode.ToString()) && !radQ1_Entertainment.Checked)
					   { %>
					...
					<% } %>
					<% if (new[] { "FD", "HA","ECS" }.Contains(PropertyShortCode.ToString()) && !radQ1_LiveRacing.Checked)
					   { %>
					...
					<% } %>
					<% if (new[] { "RR", "HRCV", "HA", "NAN", "CMR","ECS", "SSKD", "AJA", "SCBE" ,"ECF","ECGR","ECM" }.Contains(PropertyShortCode.ToString()) && !radQ1_Racebook.Checked)
					   { %>
					...
					<% } %>
					<% if (!new[] { "CNSH", "CNSS","ECS","CNB", "ECGR", "ECB"}.Contains(PropertyShortCode.ToString()) && !radQ1_Lottery.Checked)
					   { %>
				...
				<p>
					...
					<% } %>
					<% if (!new[] { "CNSH", "CNSS","ECS","CNB"}.Contains(PropertyShortCode.ToString()) && !radQ1_Lottery.Checked)
					   { %>
				...
				<p>
				  ...
				  <%--  <% if (PropertyShortCode == GCCPropertyShortCode.ECV)
					...
					<%if (PropertyShortCode == GCCPropertyShortCode.AJA || PropertyShortCode == GCCPropertyShortCode.ECB || PropertyShortCode == GCCPropertyShortCode.ECGR )
					  { %>
					<sc:SurveyCheckBox ID="Q18_58" runat="server" SessionKey="Q18_58" DBColumn="Q18_58" DBValue="1" Text="&nbsp;Getaway Bar & Grill" /><br />
				...
				<p>
					...
					<%if (PropertyShortCode == GCCPropertyShortCode.AJA || PropertyShortCode == GCCPropertyShortCode.ECB || PropertyShortCode == GCCPropertyShortCode.ECGR)
					  { %>
					<sc:SurveyCheckBox ID="Q18_58_F" runat="server" SessionKey="Q18_58" DBColumn="Q18_58" DBValue="1" Text="&nbsp;Getaway Bar & Grill" /><br />
				...
				<%if(PropertyShortCode != GCCPropertyShortCode.ECB){ %>
