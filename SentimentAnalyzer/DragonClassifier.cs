...
namespace SentimentAnalyzer
{
    public class Classifier // : IClassifier
    {
        ...
        public static IDictionary<string, double> Classify(string text) {
            var positiveEv = new Evidence( "Positive", HttpContext.Current.Server.MapPath( "~/Files/TextAnalytics/positive-evidence.csv" ) );
            var negativeEv = new Evidence( "Negative", HttpContext.Current.Server.MapPath( "~/Files/TextAnalytics/negative-evidence.csv" ) );
            Classifier clsfr = new Classifier( positiveEv, negativeEv );
            return clsfr.Classify( text, DragonHelper.ExcludeList );
        }
    }
}
